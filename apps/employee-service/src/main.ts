...
const logger = createWinstonLogger({ serviceName: "employee-service" });

const prisma = createEmployeeDbConnection();
...
app.use("/api/employees", createEmployeeRoutes(prisma, logger));
