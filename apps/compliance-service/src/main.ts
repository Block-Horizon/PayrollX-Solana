...
const logger = createWinstonLogger({ serviceName: "compliance-service" });

const prisma = createComplianceDbConnection();
...
app.use("/api/compliance", createComplianceRoutes(prisma, logger));
