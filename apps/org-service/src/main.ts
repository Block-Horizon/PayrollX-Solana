...
const logger = createWinstonLogger({ serviceName: "org-service" });

const prisma = createOrganizationDbConnection();
...
app.use("/api/organizations", createOrganizationRoutes(prisma, logger));
