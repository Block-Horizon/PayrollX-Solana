...
const logger = createWinstonLogger({ serviceName: "transaction-service" });

const prisma = createTransactionDbConnection();
...
app.use("/api/transactions", createTransactionRoutes(prisma, logger));
